 ...
 */
async function getWebRTCInfo(): Promise<{
  localIPs: string[];
  supported: boolean;
}> {
    ...
    await new Promise<void>((resolve) => {
      ...
      pc.onicecandidate = (event) => {
        ...
        const ipv6Match = candidate.match(
          /(?:[a-f0-9]{1,4}:){7}[a-f0-9]{1,4}|(?:[a-f0-9]{1,4}:){1,7}:|(?:[a-f0-9]{1,4}:){1,6}:[a-f0-9]{1,4}|(?:[a-f0-9]{1,4}:){1,5}(?::[a-f0-9]{1,4}){1,2}|(?:[a-f0-9]{1,4}:){1,4}(?::[a-f0-9]{1,4}){1,3}|(?:[a-f0-9]{1,4}:){1,3}(?::[a-f0-9]{1,4}){1,4}|(?:[a-f0-9]{1,4}:){1,2}(?::[a-f0-9]{1,4}){1,5}|[a-f0-9]{1,4}:(?::[a-f0-9]{1,4}){1,6}|:(?::[a-f0-9]{1,4}){1,7}|::(?:[a-f0-9]{1,4}:){0,5}[a-f0-9]{1,4}|fe80:(?::[a-f0-9]{0,4}){0,4}%[0-9a-z]+/i,
        );
  ...
  const checks: Array<{ name: string; check: () => boolean }> = [
    {
      ...
      check: () =>
        ...
        !!(window as Window & { __LASTPASS_EXTENSION_LOADED__?: unknown })
          .__LASTPASS_EXTENSION_LOADED__,
    },
    {
      name: "Grammarly",
      check: () =>
    ...
    },
    {
      name: "Vue DevTools",
      check: () =>
        !!(window as Window & { __VUE_DEVTOOLS_GLOBAL_HOOK__?: unknown })
          .__VUE_DEVTOOLS_GLOBAL_HOOK__,
    },
    {
      name: "Redux DevTools",
      check: () =>
        !!(window as Window & { __REDUX_DEVTOOLS_EXTENSION__?: unknown })
    ...
    },
    {
      name: "1Password",
      check: () =>
        !!document.querySelector("[data-onepassword-extension]") ||
