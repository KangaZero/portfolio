...
type Uniforms = {
  ...
  gridColor: { value: [number, number, number] }; // Assuming hexToRgb returns [r, g, b]
...
void main() {
    ...
    const resize = () => {
      if (!containerRef.current) return console.warn("No container Ref");
